...
- [x] 규칙 문서화 — 이 문서
- [ ] `feature/timeletter/presentation` (38) — @koongmai
- [ ] `feature/mindrecord/presentation` (79) — @Sadturtleman
- [ ] `feature/setting/presentation` (64) — @1hyok
- [ ] `feature/afternote/presentation` 깊이 평탄화 (116, 이미 기능별이므로 이관 아님) — @1hyok
