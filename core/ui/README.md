...
- **Popup**: [`Popup(type, ...)`](src/main/kotlin/com/afternote/core/ui/popup/Popup.kt) (`Default`·`Variant2`) / [`AfternoteErrorPopup`](src/main/kotlin/com/afternote/core/ui/popup/ErrorPopup.kt) — 오류 팝업 4종은 시안 정본대로 [`NetworkErrorPopup`](src/main/kotlin/com/afternote/core/ui/popup/ErrorPopup.kt) · [`ServerErrorPopup`](src/main/kotlin/com/afternote/core/ui/popup/ErrorPopup.kt) · [`UploadErrorPopup`](src/main/kotlin/com/afternote/core/ui/popup/ErrorPopup.kt) · [`AccessDeniedPopup`](src/main/kotlin/com/afternote/core/ui/popup/ErrorPopup.kt)(403 전용, 액션이 «확인» 이다) (#446)
