...
class PasswordChangeContentTest {
    ...
    fun typedPasswords_areForwardedAsIntents() {
        ...
        typeInto(R.string.setting_password_change_current_placeholder, "OldPass1!")
        typeInto(R.string.setting_password_change_new_placeholder, "NewPass1!")
    ...
    fun submitButton_isDisabledUntilStateAllowsIt() {
        ...
        val submit = resources.getString(R.string.setting_password_change_submit)
    ...
    fun errorMessage_isRenderedFromResourceNotServerText() {
        setContent(
            PasswordChangeUiState(errorMessage = UiText.Resource(R.string.setting_password_change_unchanged)),
            mutableListOf(),
        )

        composeRule
            .onNodeWithText(resources.getString(R.string.setting_password_change_unchanged))
            .assertIsDisplayed()
    }
