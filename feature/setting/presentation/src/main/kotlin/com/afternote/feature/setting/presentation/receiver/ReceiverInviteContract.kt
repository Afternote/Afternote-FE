...
internal sealed interface ReceiverInviteIntent : MviIntent {
 ...
 */
@Immutable
internal data class ReceiverInviteShareRequest(
    val token: String,
 ...
 */
@Immutable
internal data class ReceiverInviteUiState(
...
internal sealed interface ReceiverInviteReducerEvent : ReducerEvent {
