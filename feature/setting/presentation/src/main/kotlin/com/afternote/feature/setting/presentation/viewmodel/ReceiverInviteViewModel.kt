    ...
    constructor(
        ...
        private fun sendInvite() {
            ...
            viewModelScope.launch {
                ...
                if (senderName == null) {
                    dispatch(ReceiverInviteReducerEvent.CreateFailed(UiText.Resource(R.string.receiver_invite_sender_name_unavailable)))
                    return@launch
                }
                    ...
                    .onSuccess { created ->
                        ...
                        val messageRes =
                            if (failure is ReceiverInvitationFailure.Unauthenticated) {
                                R.string.receiver_invite_create_unauthenticated
                            } else {
                                R.string.receiver_invite_create_failed
                            }
