...
internal fun PasswordChangeContent(
    ...
    FlowStepScaffold(
        topBarTitle = stringResource(R.string.setting_account_password_change),
        actionButtonText = stringResource(R.string.setting_password_change_submit),
        ...
        Column(
            ...
            PasswordFieldLabel(text = stringResource(R.string.setting_password_change_current_label))
            AfternoteTextField(
                state = currentPasswordState,
                placeholder = stringResource(R.string.setting_password_change_current_placeholder),
            ...
            PasswordFieldLabel(text = stringResource(R.string.setting_password_change_new_label))
            AfternoteTextField(
                state = newPasswordState,
                placeholder = stringResource(R.string.setting_password_change_new_placeholder),
                keyboardType = KeyboardType.Password,
