...
internal fun ReceiverInviteSheetContent(
    ...
    Column(
        ...
        Text(
            text = stringResource(R.string.receiver_invite_sheet_title),
            style = AfternoteDesign.typography.h3,
            color = AfternoteDesign.colors.gray9,
        )
        Spacer(modifier = Modifier.height(12.dp))
        Text(
            text = stringResource(R.string.receiver_invite_sheet_description, receiverName),
        ...
        AfternoteButton(
            text = stringResource(R.string.receiver_invite_send),
            onClick = onSend,
        ...
        Spacer(modifier = Modifier.height(12.dp))
        AfternoteButton(
            text = stringResource(R.string.receiver_invite_send_later),
            onClick = onDismiss,
