 ...
 *
 * 이 저장소만 별도 암호화하지 않는다. [com.afternote.feature.receiver.data.local.ReceiverAuthCodeDataSource]와
...
private fun PersistedSenderEntry.toDomain(): SenderEntry =
    SenderEntry(
        ...
        relation = relation,
        verificationStatus = verificationStatus?.let(DeliveryVerificationStatus::fromRaw),
    )
