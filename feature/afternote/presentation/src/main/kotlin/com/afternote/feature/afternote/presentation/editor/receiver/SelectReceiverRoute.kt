...
internal fun AfternoteSelectReceiverNavigation(
    ...
    LaunchedEffect(Unit) { viewModel.onIntent(SelectReceiverIntent.ApplyPreselection(preselectedReceiverIds)) }

    SelectReceiverScreen(
        uiState = uiState,
        onBackClick = onPopBackStack,
        onReceiverToggle = { viewModel.onIntent(SelectReceiverIntent.ToggleReceiver(it)) },
        onRetryClick = { viewModel.onIntent(SelectReceiverIntent.Refresh) },
