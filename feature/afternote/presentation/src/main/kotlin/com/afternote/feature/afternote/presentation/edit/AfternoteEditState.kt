...
import com.afternote.feature.afternote.presentation.edit.ProcessingMethodManager
...
class MemorialPlaylistStateHolder {
    val songs: SnapshotStateList<com.kuit.afternote.feature.afternote.presentation.edit.model.Song> =
        mutableStateListOf()

    var onSongCountChanged: (() -> Unit)? = null

    fun initializeSongs(initialSongs: List<com.kuit.afternote.feature.afternote.presentation.edit.model.Song>) {
        if (songs.isEmpty()) {
            songs.addAll(initialSongs)
        }
    }

    fun addSong(song: com.kuit.afternote.feature.afternote.presentation.edit.model.Song) {
        songs.add(song)
...
class AfternoteEditState(
    ...
    initialAfternoteEditReceivers: List<com.kuit.afternote.feature.afternote.presentation.edit.model.AfternoteEditReceiver>,
    ...
    var selectedInformationProcessingMethod by mutableStateOf(
        _root_ide_package_.com.kuit.afternote.feature.afternote.presentation.edit.model.InformationProcessingMethod.TRANSFER_TO_AFTERNOTE_EDIT_RECEIVER,
    )
        private set
    ...
    var relationshipSelectedValue by mutableStateOf("친구")
        private set
    var activeDialog by mutableStateOf<com.kuit.afternote.feature.afternote.presentation.edit.DialogType?>(
        null,
    )
        private set
    ...
    val processingMethods: List<com.kuit.afternote.feature.afternote.presentation.edit.model.ProcessingMethodItem>
        get() = processingMethodManager.processingMethods
    val galleryProcessingMethods: List<com.kuit.afternote.feature.afternote.presentation.edit.model.ProcessingMethodItem>
    ...
    var playlistStateHolder: com.kuit.afternote.feature.afternote.presentation.edit.MemorialPlaylistStateHolder? =
        null
        private set
     ...
     * 플레이리스트 상태 홀더 설정
     */
    fun setPlaylistStateHolder(stateHolder: com.kuit.afternote.feature.afternote.presentation.edit.MemorialPlaylistStateHolder) {
    ...
    var categoryDropdownState by mutableStateOf(
        _root_ide_package_.com.kuit.afternote.feature.afternote.presentation.edit.dropdown
    ...
    val galleryAfternoteEditReceiverCallbacks: com.kuit.afternote.feature.afternote.presentation.edit.model.AfternoteEditReceiverCallbacks by lazy {
        _root_ide_package_.com.kuit.afternote.feature.afternote.presentation.edit.model.AfternoteEditReceiverCallbacks(
    ...
    val galleryProcessingCallbacks: com.kuit.afternote.feature.afternote.presentation.edit.model.ProcessingMethodCallbacks by lazy {
        _root_ide_package_.com.kuit.afternote.feature.afternote.presentation.edit.model.ProcessingMethodCallbacks(
    ...
    val socialProcessingCallbacks: com.kuit.afternote.feature.afternote.presentation.edit.model.ProcessingMethodCallbacks by lazy {
        _root_ide_package_.com.kuit.afternote.feature.afternote.presentation.edit.model.ProcessingMethodCallbacks(
    ...
    fun onProcessingMethodSelected(method: com.kuit.afternote.feature.afternote.presentation.edit.model.AccountProcessingMethod) {
        selectedProcessingMethod = method
    }

    fun onInformationProcessingMethodSelected(
        method: com.kuit.afternote.feature.afternote.presentation.edit.model.InformationProcessingMethod,
    ) {
    ...
    fun loadFromExisting(params: LoadFromExistingParams) {
        ...
        if (params.processing.informationMethodName.isNotEmpty()) {
            ...
            selectedInformationProcessingMethod =
                runCatching {
                    _root_ide_package_.com.kuit.afternote.feature.afternote.presentation.edit.model.InformationProcessingMethod.valueOf(
                        infoMethodName,
                    )
                }.getOrDefault(
                    _root_ide_package_.com.kuit.afternote.feature.afternote.presentation.edit.model.InformationProcessingMethod.TRANSFER_TO_AFTERNOTE_EDIT_RECEIVER,
