...
private val DISPLAY_ENTRIES: List<DisplayEntry> =
    listOf(
        ...
        DisplayEntry(
            ...
            R.drawable.img_naver_mail_pattern,
        ),
        DisplayEntry(
            "FACEBOOK",
            "페이스북",
            R.string.afternote_category_social_network,
            R.drawable.img_facebook_pattern,
        ),
        DisplayEntry(
            "X",
            "X",
            R.string.afternote_category_social_network,
            R.drawable.img_x_pattern,
        ),
        DisplayEntry(
            "THREAD",
            "스레드",
            R.string.afternote_category_social_network,
            R.drawable.img_thread_pattern,
        ),
        DisplayEntry(
            "TIKTOK",
            "틱톡",
            R.string.afternote_category_social_network,
            R.drawable.img_tiktok_pattern,
        ),
        DisplayEntry(
            "YOUTUBE",
            "유튜브",
            R.string.afternote_category_social_network,
            R.drawable.img_youtube_pattern,
        ),
        DisplayEntry(
            "KAKAOTALK",
            "카카오톡",
            R.string.afternote_category_social_network,
            R.drawable.img_kakaotalk_pattern,
        ),
        DisplayEntry(
            "KAKAOSTORY",
            "카카오스토리",
            R.string.afternote_category_social_network,
            R.drawable.img_kakaostory_pattern,
        ),
        DisplayEntry(
            "NAVER_BLOG",
            "네이버 블로그",
            R.string.afternote_category_social_network,
            R.drawable.img_naverblog_pattern,
        ),
        DisplayEntry(
            "NAVER_CAFE",
            "네이버 카페",
            R.string.afternote_category_social_network,
            R.drawable.img_navercafe_pattern,
        ),
        DisplayEntry(
            "NAVER_BAND",
            "네이버 밴드",
            R.string.afternote_category_social_network,
            R.drawable.img_naverband_pattern,
        ),
        DisplayEntry(
            "DISCORD",
            "디스코드",
            R.string.afternote_category_social_network,
            R.drawable.img_discord_pattern,
        ),
        DisplayEntry(
            "GOOGLE_PHOTO",
            "구글 포토",
            R.string.receiver_afternote_item_gallery,
            R.drawable.img_googlephoto_pattern,
        ),
        DisplayEntry(
            "MYBOX",
            "네이버 MYBOX",
            R.string.receiver_afternote_item_gallery,
            R.drawable.img_mybox_pattern,
        ),
        DisplayEntry(
            "ICLOUD",
            "아이클라우드",
            R.string.receiver_afternote_item_gallery,
            R.drawable.img_icloud_pattern,
        ),
        DisplayEntry(
            "ONEDRIVE",
            "Onedrive",
            R.string.receiver_afternote_item_gallery,
            R.drawable.img_onedrive_pattern,
        ),
        DisplayEntry(
            "TALKDRIVE",
            "카카오톡 톡서랍",
            R.string.receiver_afternote_item_gallery,
            R.drawable.img_talkdrive_pattern,
        ),
        ...
        DisplayEntry(
            ...
            drawableResId = R.drawable.ic_gallery_pattern,
        ),
    )
