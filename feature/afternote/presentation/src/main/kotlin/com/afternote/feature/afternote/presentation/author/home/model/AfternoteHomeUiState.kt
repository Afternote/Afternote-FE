 ...
 */
data class AfternoteHomeNavState(
 ...
 */
data class AfternoteHomeCategoryState(
 ...
 */
data class AfternoteHomeListState(
 ...
 * 애프터노트 목록(홈) 화면 UI 상태.
 *
 * 페이지네이션에 필요한 상태는 [AfternoteHomeListState]에 두고, 하단 네비·카테고리 필터와
...
data class AfternoteHomeUiState(
    val navState: AfternoteHomeNavState = AfternoteHomeNavState(),
    val categoryState: AfternoteHomeCategoryState = AfternoteHomeCategoryState(),
    val listState: AfternoteHomeListState = AfternoteHomeListState(),
)
