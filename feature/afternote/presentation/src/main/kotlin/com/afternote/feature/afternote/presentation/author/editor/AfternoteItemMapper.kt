...
object AfternoteItemMapper {
    ...
    /**
     * Edit screen category dropdown value from [com.afternote.feature.afternote.domain.AfternoteServiceType].
     ...
     */
    private fun inferServiceType(serviceName: String): AfternoteServiceType = AfternoteServiceCatalog.serviceTypeFor(serviceName)
