...
import com.afternote.feature.afternote.presentation.shared.ui.component.list.SongPlaylistScreenSelectableOptions
...
data class AddSongCallbacks(
    ...
    val onSongsAdded: (List<com.afternote.feature.afternote.presentation.author.edit.model.Song>) -> Unit,
)
