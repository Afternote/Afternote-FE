...
object AfternoteEditorDummies {
    /**
     * Default processing method visibleItems for record-type services (애프터노트 수정 화면). Dummy data.
     */
    ...
    /**
     * Default processing method visibleItems for gallery/file-type services. Dummy data.
     */
     ...
     */
    fun defaultAfternoteEditorReceivers(): List<com.afternote.feature.afternote.presentation.author.editor.model.AfternoteEditorReceiver> =
        listOf(
